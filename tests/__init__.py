...
class StatusCodeTests(BaseCase):
    def test_404(self):
        ...
        self.assertRaises(urequests2.HTTPNotFound, urequests2.get, 'http://google.com/404')

    def test_500(self):
        self.assertRaises(urequests2.HTTPInternalError, urequests2.post, "http://www.mplsart.com/api/posts?spork=true")
...
class ConnectionCodeTests(BaseCase):
    ...
    def test_bad_domain(self):
        ...
        try:
            result = urllib2.urlopen('http://notarealdomainxx111.x/api/derp/')
